...
the Y of the a0r0 is "1334680.0".
...
the Y of the a3r0 is "1334420.0".
...
the X of the a4r0 is "568486.0".
the Y of the a4r0 is "1334420.0".
...
the X of the a7r0 is "568226.0".
the Y of the a7r0 is "1334680.0".
...
the Y of the a8r0 is "1334680.0".
...
the X of the a11r0 is "567720.0".
the Y of the a11r0 is "1334680.0".
...
the X of the a12r0 is "566086.0".
the Y of the a12r0 is "1334680.0".
...
the X of the a15r0 is "565826.0".
the Y of the a15r0 is "1334680.0".
...
the Y of the a9r1 is "1336480.0".
...
the X of the a10r1 is "567720.0".
the Y of the a10r1 is "1336480.0".
...
the X of the a5r2 is "568486.0".
the Y of the a5r2 is "1336480.0".
...
the X of the a6r2 is "568226.0".
the Y of the a6r2 is "1336480.0".
...
the Y of the a1r3 is "1335580.0".
...
the Y of the a2r3 is "1335580.0".
...
the X of the a13r4 is "566086.0".
the Y of the a13r4 is "1335580.0".
...
the X of the a14r4 is "565826.0".
the Y of the a14r4 is "1335580.0".
...
[create d1]
d1 is a door. "A door between a7r0 and a6r2".
d1 is north of a7r0 and south of a6r2.

[create d2]
d2 is a door. "A door between a8r0 and a9r1".
d2 is north of a8r0 and south of a9r1.

[create d3]
d3 is a door. "A door between a11r0 and a10r1".
d3 is north of a11r0 and south of a10r1.

[create d4]
d4 is a door. "A door between a12r0 and a13r4".
d4 is north of a12r0 and south of a13r4.

[create d5]
d5 is a door. "A door between a15r0 and a14r4".
d5 is north of a15r0 and south of a14r4.

[create d6]
d6 is a door. "A door between a0r0 and a1r3".
d6 is north of a0r0 and south of a1r3.

[create d7]
d7 is a door. "A door between a3r0 and a2r3".
d7 is north of a3r0 and south of a2r3.
...
west of a13r4 is east of a14r4.

east of a0r0 is west of a15r0.
