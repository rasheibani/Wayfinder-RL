...
the X of the a3r0 is "525475.83171186".
the Y of the a3r0 is "2235284.262724309".
...
the X of the a4r0 is "526375.7806968184".
the Y of the a4r0 is "2235229.295908396".
...
the X of the a5r0 is "526534.5072611612".
the Y of the a5r0 is "2236011.9957118793".
...
the X of the a7r0 is "526748.1263715166".
the Y of the a7r0 is "2235513.8307153364".
...
the X of the a8r0 is "528798.9728960394".
the Y of the a8r0 is "2236002.509058375".
...
the X of the a10r0 is "528696.8240414555".
the Y of the a10r0 is "2235205.936959245".
...
the X of the a15r0 is "525381.140060046".
the Y of the a15r0 is "2235736.181603638".
...
the X of the a16r0 is "527659.9745288973".
the Y of the a16r0 is "2235707.976167537".
...
the X of the a17r0 is "527617.8953955586".
the Y of the a17r0 is "2235502.8314628876".
...
the X of the a18r0 is "526578.602608604".
the Y of the a18r0 is "2235221.719391291".
...
the X of the a20r0 is "527610.566213656".
the Y of the a20r0 is "2235388.698007508".
...
the X of the a21r0 is "525413.0".
the Y of the a21r0 is "2235768.0".
...
the X of the a22r0 is "527663.0908519333".
the Y of the a22r0 is "2235688.096196165".
...
the X of the a0r1 is "525810.5134994971".
the Y of the a0r1 is "2237114.603460867".
...
the X of the a1r1 is "525362.2834350008".
the Y of the a1r1 is "2236530.923132617".
...
the X of the a2r1 is "526002.1402841746".
the Y of the a2r1 is "2236201.0770812994".
...
the X of the a6r1 is "526053.7143569188".
the Y of the a6r1 is "2236132.2645028587".
...
the X of the a9r1 is "527864.5085053628".
the Y of the a9r1 is "2236232.7308673826".
...
the X of the a11r1 is "528588.0155008155".
the Y of the a11r1 is "2237070.4653119235".
...
the X of the a12r1 is "529026.8841058412".
the Y of the a12r1 is "2236648.760473517".
...
the X of the a13r1 is "527124.9167995494".
the Y of the a13r1 is "2237113.004878141".
...
the X of the a14r1 is "527619.5634312476".
the Y of the a14r1 is "2236854.081765874".
...
the X of the a19r1 is "526394.5482646531".
the Y of the a19r1 is "2236998.6613371735".
...
the X of the a23r1 is "529064.0".
the Y of the a23r1 is "2236620.0".

[create d0]
d0 is a door. "A door between a5r0 and a6r1".
d0 is west of a5r0 and east of a6r1.

[create d1]
d1 is a door. "A door between a8r0 and a9r1".
d1 is west of a8r0 and east of a9r1.

[create d2]
d2 is a door. "A door between a17r0 and a9r1".
d2 is north of a17r0 and south of a9r1.

[create d3]
d3 is a door. "A door between a4r0 and a6r1".
d3 is north of a4r0 and south of a6r1.
...
southeast of a5r0 is northwest of a7r0.

south of a8r0 is north of a10r0.

southeast of a11r1 is northwest of a12r1.

southeast of a13r1 is northwest of a14r1.

north of a3r0 is south of a15r0.

south of a16r0 is north of a17r0.

north of a9r1 is south of a14r1.

west of a11r1 is east of a14r1.

east of a4r0 is west of a18r0.

west of a13r1 is east of a19r1.

east of a0r1 is west of a19r1.

northeast of a2r1 is southwest of a19r1.

east of a18r0 is west of a20r0.

west of a10r0 is east of a20r0.

southwest of a7r0 is northeast of a18r0.

south of a17r0 is north of a20r0.

southeast of a2r1 is northwest of a6r1.

northeast of a15r0 is southwest of a21r0.

south of a16r0 is north of a22r0.
