...
the X of the a4r0 is "525545.7188426536".
the Y of the a4r0 is "1315465.5777999226".
...
the X of the a5r0 is "526033.6402035004".
the Y of the a5r0 is "1315570.682520715".
...
the X of the a8r0 is "527089.6024476527".
the Y of the a8r0 is "1315595.9309555213".
...
the X of the a9r0 is "527128.3272207854".
the Y of the a9r0 is "1315810.4358128451".
...
the X of the a17r0 is "527512.9473578264".
the Y of the a17r0 is "1315417.1323193454".
...
the X of the a18r0 is "524946.6865942029".
the Y of the a18r0 is "1315089.6751110333".
...
the X of the a21r0 is "527230.8447955904".
the Y of the a21r0 is "1315794.4166666665".
...
the X of the a24r0 is "527545.0".
the Y of the a24r0 is "1315391.0".
...
the X of the a25r0 is "527264.9848545926".
the Y of the a25r0 is "1315743.1407428735".
...
the X of the a28r0 is "524948.0".
the Y of the a28r0 is "1315139.0".
...
the X of the a0r1 is "527066.9408485321".
the Y of the a0r1 is "1317292.6428906291".
...
the X of the a1r1 is "527054.0752761008".
the Y of the a1r1 is "1316810.3498158022".
...
the X of the a2r1 is "526748.3067828343".
the Y of the a2r1 is "1317442.2601948914".
...
the X of the a3r1 is "526032.3445626477".
the Y of the a3r1 is "1317334.3503250591".
...
the X of the a6r1 is "525585.5".
the Y of the a6r1 is "1317340.8551682692".
...
the X of the a7r1 is "526033.3784065933".
the Y of the a7r1 is "1316479.5".
...
the X of the a10r1 is "527121.9530685921".
the Y of the a10r1 is "1316443.0".
...
the X of the a11r1 is "527717.1772243825".
the Y of the a11r1 is "1316395.9779589574".
...
the X of the a12r1 is "526731.0419668956".
the Y of the a12r1 is "1316528.02277555".
...
the X of the a13r1 is "527115.0248919196".
the Y of the a13r1 is "1316472.524691358".
...
the X of the a14r1 is "526913.4238983432".
the Y of the a14r1 is "1316668.5192711016".
...
the X of the a15r1 is "525215.0876068376".
the Y of the a15r1 is "1317488.1662393163".
...
the X of the a19r1 is "526919.5349209957".
the Y of the a19r1 is "1316658.3120970805".
...
the X of the a20r1 is "526741.8264604812".
the Y of the a20r1 is "1317505.767353952".
...
the X of the a22r1 is "525184.0".
the Y of the a22r1 is "1317514.0".
...
the X of the a26r1 is "526971.0".
the Y of the a26r1 is "1316617.0".
...
the X of the a27r1 is "526710.0".
the Y of the a27r1 is "1317514.0".
...
the X of the a16r2 is "528609.5645125472".
the Y of the a16r2 is "1315460.8024650232".
...
the X of the a23r2 is "528642.0".
the Y of the a23r2 is "1315480.0".

[create d0]
d0 is a door. "A door between a4r0 and a6r1".
d0 is north of a4r0 and south of a6r1.

[create d1]
d1 is a door. "A door between a5r0 and a7r1".
d1 is north of a5r0 and south of a7r1.

[create d2]
d2 is a door. "A door between a11r1 and a16r2".
d2 is southeast of a11r1 and northwest of a16r2.

[create d3]
d3 is a door. "A door between a9r0 and a10r1".
d3 is north of a9r0 and south of a10r1.
...
east of a7r1 is west of a12r1.

northeast of a12r1 is southwest of a14r1.

south of a3r1 is north of a7r1.

southwest of a1r1 is northeast of a14r1.

west of a6r1 is east of a15r1.

southeast of a8r0 is northwest of a17r0.

east of a5r0 is west of a8r0.

south of a1r1 is north of a13r1.

southwest of a4r0 is northeast of a18r0.

southeast of a0r1 is northwest of a11r1.

southeast of a14r1 is northwest of a19r1.

north of a2r1 is south of a20r1.

east of a9r0 is west of a21r0.

north of a10r1 is south of a13r1.

west of a3r1 is east of a6r1.

northwest of a15r1 is southeast of a22r1.

northeast of a16r2 is southwest of a23r2.

southeast of a17r0 is northwest of a24r0.

southeast of a21r0 is northwest of a25r0.

southeast of a19r1 is northwest of a26r1.

west of a20r1 is east of a27r1.

north of a18r0 is south of a28r0.
