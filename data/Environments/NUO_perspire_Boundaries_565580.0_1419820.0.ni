...
the X of the a0r0 is "566996.0".
the Y of the a0r0 is "1419820.0".
...
the Y of the a7r0 is "1420080.0".
...
the Y of the a11r0 is "1419820.0".
...
the Y of the a1r1 is "1418020.0".
...
the X of the a5r1 is "568617.0".
the Y of the a5r1 is "1418280.0".
...
the Y of the a6r1 is "1418280.0".
...
the X of the a3r2 is "571277.0".
the Y of the a3r2 is "1420080.0".
...
the X of the a9r3 is "565320.0".
the Y of the a9r3 is "1418020.0".
...
the X of the a10r3 is "565580.0".
the Y of the a10r3 is "1418020.0".

[create d0]
d0 is a door. "A door between a2r1 and a3r2".
d0 is north of a2r1 and south of a3r2.

[create d1]
d1 is a door. "A door between a0r0 and a1r1".
d1 is south of a0r0 and north of a1r1.
...
d4 is south of a7r0 and north of a6r1.

[create d5]
d5 is a door. "A door between a5r1 and a4r2".
d5 is north of a5r1 and south of a4r2.
