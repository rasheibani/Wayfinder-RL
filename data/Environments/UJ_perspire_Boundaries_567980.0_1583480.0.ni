...
the X of the a2r0 is "566941.0".
the Y of the a2r0 is "1581680.0".
...
the X of the a3r0 is "565580.0".
the Y of the a3r0 is "1581680.0".
...
the Y of the a6r0 is "1581420.0".
...
the X of the a7r0 is "569601.0".
the Y of the a7r0 is "1581420.0".
...
the X of the a10r0 is "569341.0".
the Y of the a10r0 is "1581680.0".
...
the X of the a11r0 is "567980.0".
the Y of the a11r0 is "1581680.0".
...
the X of the a14r0 is "567720.0".
the Y of the a14r0 is "1581680.0".
...
the X of the a15r0 is "567201.0".
the Y of the a15r0 is "1581680.0".
...
the X of the a0r1 is "567201.0".
the Y of the a0r1 is "1582580.0".
...
the X of the a1r1 is "566941.0".
the Y of the a1r1 is "1582580.0".
...
the Y of the a12r2 is "1583480.0".
...
the X of the a13r2 is "567720.0".
the Y of the a13r2 is "1583480.0".
...
the X of the a8r3 is "569601.0".
the Y of the a8r3 is "1583480.0".
...
the X of the a9r3 is "569341.0".
the Y of the a9r3 is "1583480.0".
...
the X of the a4r4 is "565580.0".
the Y of the a4r4 is "1583480.0".
...
the X of the a5r4 is "565320.0".
the Y of the a5r4 is "1583480.0".

[create d0]
d0 is a door. "A door between a7r0 and a8r3".
d0 is north of a7r0 and south of a8r3.

[create d1]
d1 is a door. "A door between a11r0 and a12r2".
d1 is north of a11r0 and south of a12r2.

[create d2]
d2 is a door. "A door between a14r0 and a13r2".
d2 is north of a14r0 and south of a13r2.

[create d3]
d3 is a door. "A door between a2r0 and a1r1".
d3 is north of a2r0 and south of a1r1.

[create d4]
d4 is a door. "A door between a15r0 and a0r1".
d4 is north of a15r0 and south of a0r1.

[create d5]
d5 is a door. "A door between a3r0 and a4r4".
d5 is north of a3r0 and south of a4r4.

[create d6]
d6 is a door. "A door between a6r0 and a5r4".
d6 is north of a6r0 and south of a5r4.

[create d7]
d7 is a door. "A door between a10r0 and a9r3".
d7 is north of a10r0 and south of a9r3.

west of a0r1 is east of a1r1.

west of a2r0 is east of a3r0.

west of a4r4 is east of a5r4.

east of a6r0 is west of a7r0.

west of a8r3 is east of a9r3.
