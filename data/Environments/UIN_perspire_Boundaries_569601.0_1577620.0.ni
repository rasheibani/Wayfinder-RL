...
the Y of the a2r0 is "1577880.0".
...
the Y of the a3r0 is "1577880.0".
...
the Y of the a6r0 is "1577620.0".
...
the Y of the a7r0 is "1577620.0".
...
the X of the a0r1 is "569861.0".
the Y of the a0r1 is "1579680.0".
...
the Y of the a1r1 is "1579680.0".
...
the Y of the a8r1 is "1579420.0".
...
the X of the a9r1 is "569601.0".
the Y of the a9r1 is "1579420.0".
...
the X of the a10r2 is "569601.0".
the Y of the a10r2 is "1577620.0".
...
the X of the a11r2 is "569861.0".
the Y of the a11r2 is "1577620.0".
...
the X of the a4r3 is "565580.0".
the Y of the a4r3 is "1579680.0".
...
the X of the a5r3 is "565320.0".
the Y of the a5r3 is "1579680.0".

[create d0]
d0 is a door. "A door between a9r1 and a10r2".
d0 is south of a9r1 and north of a10r2.

[create d1]
d1 is a door. "A door between a0r1 and a11r2".
d1 is south of a0r1 and north of a11r2.

[create d2]
d2 is a door. "A door between a2r0 and a1r1".
d2 is north of a2r0 and south of a1r1.

[create d3]
d3 is a door. "A door between a3r0 and a4r3".
d3 is north of a3r0 and south of a4r3.

[create d4]
d4 is a door. "A door between a6r0 and a5r3".
d4 is north of a6r0 and south of a5r3.

[create d5]
d5 is a door. "A door between a7r0 and a8r1".
d5 is north of a7r0 and south of a8r1.

west of a0r1 is east of a1r1.

west of a2r0 is east of a3r0.

west of a4r3 is east of a5r3.
