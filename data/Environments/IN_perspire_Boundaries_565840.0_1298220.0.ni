...
the Y of the a6r0 is "1296420.0".
...
the X of the a7r0 is "565840.0".
the Y of the a7r0 is "1296420.0".
...
the X of the a0r1 is "565840.0".
the Y of the a0r1 is "1298220.0".
...
the Y of the a1r1 is "1298220.0".
...
the X of the a4r1 is "568240.0".
the Y of the a4r1 is "1298480.0".
...
the Y of the a5r1 is "1298480.0".
...
the X of the a2r2 is "567980.0".
the Y of the a2r2 is "1296420.0".
...
the Y of the a3r2 is "1296420.0".

[create d0]
d0 is a door. "A door between a1r1 and a2r2".
d0 is south of a1r1 and north of a2r2.

[create d1]
d1 is a door. "A door between a4r1 and a3r2".
d1 is south of a4r1 and north of a3r2.

[create d2]
d2 is a door. "A door between a6r0 and a5r1".
d2 is north of a6r0 and south of a5r1.

[create d3]
d3 is a door. "A door between a7r0 and a0r1".
d3 is north of a7r0 and south of a0r1.
