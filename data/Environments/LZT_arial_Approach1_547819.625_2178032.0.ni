...
the X of the a2r0 is "545261.3750000002".
the Y of the a2r0 is "2180201.379310345".
...
the X of the a3r0 is "545370.4497203713".
the Y of the a3r0 is "2180094.286194327".
...
the X of the a4r0 is "545479.6250000002".
the Y of the a4r0 is "2180201.8461538465".
...
the X of the a27r0 is "545225.0".
the Y of the a27r0 is "2180240.0".
...
the X of the a28r0 is "545516.0".
the Y of the a28r0 is "2180240.0".
...
the X of the a8r1 is "547728.2373015874".
the Y of the a8r1 is "2178128.0".
...
the X of the a9r1 is "547819.625".
the Y of the a9r1 is "2178224.0".
...
the X of the a12r1 is "545386.0296276822".
the Y of the a12r1 is "2178160.7255749586".
...
the X of the a13r1 is "546288.0".
the Y of the a13r1 is "2178195.4930555555".
...
the X of the a16r1 is "547819.625".
the Y of the a16r1 is "2178032.0".
...
the X of the a19r1 is "545262.3333333334".
the Y of the a19r1 is "2178038.620689655".
...
the X of the a20r1 is "546288.0".
the Y of the a20r1 is "2178180.662308674".
...
the X of the a21r1 is "546121.0".
the Y of the a21r1 is "2178256.0".
...
the X of the a22r1 is "546189.7395833334".
the Y of the a22r1 is "2178261.0".
...
the X of the a23r1 is "545225.0".
the Y of the a23r1 is "2178000.0".
...
the X of the a24r1 is "547859.0".
the Y of the a24r1 is "2178256.0".
...
the X of the a31r1 is "547859.0".
the Y of the a31r1 is "2178000.0".
...
the X of the a0r2 is "546378.1727682715".
the Y of the a0r2 is "2180112.0".
...
the X of the a1r2 is "547646.0295950505".
the Y of the a1r2 is "2180057.218565202".
...
the X of the a5r2 is "546286.4642857143".
the Y of the a5r2 is "2180208.0".
...
the X of the a6r2 is "548938.2295480026".
the Y of the a6r2 is "2180112.8284665653".
...
the X of the a7r2 is "549029.09375".
the Y of the a7r2 is "2180208.0".
...
the X of the a10r2 is "548195.5".
the Y of the a10r2 is "2180071.1876296997".
...
the X of the a14r2 is "546286.4642857143".
the Y of the a14r2 is "2180016.0".
...
the X of the a15r2 is "549031.65".
the Y of the a15r2 is "2180016.0".
...
the X of the a25r2 is "546248.0".
the Y of the a25r2 is "2179984.0".
...
the X of the a26r2 is "549068.0".
the Y of the a26r2 is "2179984.0".
...
the X of the a29r2 is "546248.0".
the Y of the a29r2 is "2180240.0".
...
the X of the a30r2 is "549068.0".
the Y of the a30r2 is "2180240.0".
...
the X of the a11r3 is "548195.4999999999".
the Y of the a11r3 is "2178145.665870231".
...
the X of the a17r3 is "548086.375".
the Y of the a17r3 is "2178038.153846154".
...
the X of the a18r3 is "548304.625".
the Y of the a18r3 is "2178038.153846154".
...
the X of the a32r3 is "548050.0".
the Y of the a32r3 is "2178000.0".
...
the X of the a33r3 is "548341.0".
the Y of the a33r3 is "2178000.0".

[create d0]
d0 is a door. "A door between a10r2 and a11r3".
d0 is south of a10r2 and north of a11r3.

[create d2]
d2 is a door. "A door between a3r0 and a12r1".
d2 is south of a3r0 and north of a12r1.

[create d4]
d4 is a door. "A door between a13r1 and a1r2".
d4 is northeast of a13r1 and southwest of a1r2.
...
northwest of a0r2 is southeast of a5r2.

northeast of a6r2 is southwest of a7r2.

northeast of a8r1 is southwest of a9r1.

southwest of a0r2 is northeast of a14r2.

southeast of a6r2 is northwest of a15r2.

west of a6r2 is east of a10r2.

east of a1r2 is west of a10r2.

southeast of a8r1 is northwest of a16r1.

southwest of a11r3 is northeast of a17r3.

southeast of a11r3 is northwest of a18r3.

southwest of a12r1 is northeast of a19r1.

west of a8r1 is east of a20r1.

east of a12r1 is west of a20r1.

east of a21r1 is west of a22r1.

southwest of a19r1 is northeast of a23r1.

northeast of a9r1 is southwest of a24r1.

southwest of a14r2 is northeast of a25r2.

southeast of a15r2 is northwest of a26r2.

northwest of a2r0 is southeast of a27r0.

northeast of a4r0 is southwest of a28r0.

northwest of a5r2 is southeast of a29r2.

northeast of a7r2 is southwest of a30r2.

southeast of a16r1 is northwest of a31r1.

southwest of a17r3 is northeast of a32r3.

southeast of a18r3 is northwest of a33r3.

south of a13r1 is north of a20r1.

northwest of a13r1 is southeast of a22r1.
