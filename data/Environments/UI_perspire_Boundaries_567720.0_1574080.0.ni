...
the Y of the a0r0 is "1573820.0".
...
the X of the a3r0 is "567720.0".
the Y of the a3r0 is "1574080.0".
...
the X of the a4r0 is "567201.0".
the Y of the a4r0 is "1574080.0".
...
the X of the a7r0 is "566941.0".
the Y of the a7r0 is "1574080.0".
...
the Y of the a8r0 is "1574080.0".
...
the Y of the a11r0 is "1573820.0".
...
the Y of the a5r1 is "1575880.0".
...
the X of the a6r1 is "566941.0".
the Y of the a6r1 is "1575880.0".
...
the Y of the a1r2 is "1575880.0".
...
the X of the a2r2 is "567720.0".
the Y of the a2r2 is "1575880.0".
...
the X of the a9r3 is "565580.0".
the Y of the a9r3 is "1575880.0".
...
the Y of the a10r3 is "1575880.0".
...
d1 is north of a3r0 and south of a2r2.

[create d2]
d2 is a door. "A door between a4r0 and a5r1".
d2 is north of a4r0 and south of a5r1.

[create d3]
d3 is a door. "A door between a7r0 and a6r1".
d3 is north of a7r0 and south of a6r1.

[create d4]
d4 is a door. "A door between a8r0 and a9r3".
d4 is north of a8r0 and south of a9r3.

[create d5]
d5 is a door. "A door between a11r0 and a10r3".
d5 is north of a11r0 and south of a10r3.
