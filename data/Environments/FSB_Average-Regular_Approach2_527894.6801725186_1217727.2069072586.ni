...
the X of the a2r0 is "528139.4364745006".
the Y of the a2r0 is "1216820.8164049922".
...
the X of the a3r0 is "528204.7889847049".
the Y of the a3r0 is "1217638.4744526066".
...
the X of the a5r0 is "526267.5331306304".
the Y of the a5r0 is "1216741.6719487428".
...
the X of the a6r0 is "526212.4164161287".
the Y of the a6r0 is "1217133.701012468".
...
the X of the a9r0 is "527128.5648964241".
the Y of the a9r0 is "1217472.5717115132".
...
the X of the a17r0 is "527188.7686849609".
the Y of the a17r0 is "1216777.6014562265".
...
the X of the a21r0 is "526222.0".
the Y of the a21r0 is "1217168.0".
...
the X of the a4r1 is "527894.6801725186".
the Y of the a4r1 is "1217727.2069072586".
...
the X of the a7r1 is "526275.466517009".
the Y of the a7r1 is "1217666.0".
...
the X of the a8r1 is "526405.5176609411".
the Y of the a8r1 is "1217883.6232469701".
...
the X of the a10r1 is "527197.5536984892".
the Y of the a10r1 is "1217679.5".
...
the X of the a11r1 is "527197.1852338063".
the Y of the a11r1 is "1218535.049454645".
...
the X of the a12r1 is "528163.25583807".
the Y of the a12r1 is "1218113.8317766765".
...
the X of the a13r1 is "525524.6938780324".
the Y of the a13r1 is "1218537.1383829594".
...
the X of the a14r1 is "525530.0929783393".
the Y of the a14r1 is "1217666.0".
...
the X of the a15r1 is "528163.085465707".
the Y of the a15r1 is "1218359.569250254".
...
the X of the a16r1 is "526412.7901426004".
the Y of the a16r1 is "1218576.9013039093".
...
the X of the a18r1 is "525150.915378007".
the Y of the a18r1 is "1218688.1834621993".
...
the X of the a19r1 is "528186.1889534884".
the Y of the a19r1 is "1218106.5".
...
the X of the a20r1 is "528227.265503876".
the Y of the a20r1 is "1218387.1666666667".
...
the X of the a22r1 is "525120.0".
the Y of the a22r1 is "1218714.0".
...
the X of the a23r1 is "528307.0".
the Y of the a23r1 is "1218071.0".
...
the X of the a24r1 is "528307.0".
the Y of the a24r1 is "1218422.0".
...
the X of the a0r2 is "525525.0".
the Y of the a0r2 is "1216781.5423704972".
...
the X of the a1r2 is "525120.0059757694".
the Y of the a1r2 is "1216660.657907662".
...
the X of the a25r2 is "525089.0".
the Y of the a25r2 is "1216680.0".

[create d0]
d0 is a door. "A door between a3r0 and a4r1".
d0 is west of a3r0 and east of a4r1.

[create d1]
d1 is a door. "A door between a9r0 and a8r1".
d1 is northwest of a9r0 and southeast of a8r1.

[create d2]
d2 is a door. "A door between a9r0 and a10r1".
d2 is north of a9r0 and south of a10r1.

[create d3]
d3 is a door. "A door between a14r1 and a0r2".
d3 is south of a14r1 and north of a0r2.
...
west of a4r1 is east of a10r1.

north of a10r1 is south of a11r1.

northeast of a4r1 is southwest of a12r1.

south of a13r1 is north of a14r1.

north of a12r1 is south of a15r1.

east of a11r1 is west of a15r1.

east of a13r1 is west of a16r1.

east of a5r0 is west of a17r0.

west of a13r1 is east of a18r1.

west of a2r0 is east of a17r0.

south of a9r0 is north of a17r0.

north of a8r1 is south of a16r1.

west of a11r1 is east of a16r1.

east of a12r1 is west of a19r1.

northeast of a15r1 is southwest of a20r1.

west of a7r1 is east of a14r1.

north of a6r0 is south of a21r0.

northwest of a18r1 is southeast of a22r1.

east of a19r1 is west of a23r1.

northeast of a20r1 is southwest of a24r1.

northwest of a1r2 is southeast of a25r2.
