...
the Y of the a1r0 is "1611820.0".
...
the Y of the a2r0 is "1611820.0".
...
the Y of the a5r0 is "1612080.0".
...
the X of the a6r0 is "566780.0".
the Y of the a6r0 is "1612080.0".
...
the Y of the a9r0 is "1612080.0".
...
the X of the a10r0 is "565580.0".
the Y of the a10r0 is "1612080.0".
...
the Y of the a7r1 is "1613880.0".
...
the X of the a8r1 is "566520.0".
the Y of the a8r1 is "1613880.0".
...
the Y of the a3r2 is "1613880.0".
...
the X of the a4r2 is "567720.0".
the Y of the a4r2 is "1613880.0".
...
the X of the a0r3 is "565320.0".
the Y of the a0r3 is "1613880.0".
...
the Y of the a11r3 is "1613880.0".

[create d0]
d0 is a door. "A door between a2r0 and a3r2".
d0 is north of a2r0 and south of a3r2.

[create d1]
d1 is a door. "A door between a5r0 and a4r2".
d1 is north of a5r0 and south of a4r2.

[create d2]
d2 is a door. "A door between a6r0 and a7r1".
d2 is north of a6r0 and south of a7r1.
...
[create d4]
d4 is a door. "A door between a1r0 and a0r3".
d4 is north of a1r0 and south of a0r3.

[create d5]
d5 is a door. "A door between a10r0 and a11r3".
d5 is north of a10r0 and south of a11r3.
