...
def evaluate_curriculum_models(max_seen_envs=5, max_unseen_envs=5, random_seed=2):
    """
    ...
    for reward_type in reward_types:
        ...
        model_path = f'data/trained/curriculum/DQN/{reward_type}/best_model.zip'
        ...
        for grammar in grammars:
            ...
            for env_info in tqdm(eval_envs, desc="Environments"):
                ...
                random_rewards = evaluate_random_agent(env, n_eval_episodes=30)
    ...
    df.to_csv('data/curriculum_evaluation_results_DQN.csv', index=False)
    print("\nEvaluation complete. Results saved to curriculum_evaluation_results_DQN.csv")
    return df
...
def learn_envs(environments, max_iterations=10000):
    ...
    for reward_type in reward_types:
        ...
        model = None
        curriculum_model_dir = f'data/trained/curriculum/DQN/{reward_type}'
